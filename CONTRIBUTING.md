...
First off, thank you for considering contributing to Spark Home!

### Project philosophy

Spark Home is meant to be a light and very simple dashboard that keeps all your useful utilities at hand. The few features implemented in Spark Home focus on
...
First of all, we expect everyone (contributors and maintainers alike) to respect the [Code of conduct](https://github.com/sstallion/spark-home/blob/main/CODE_OF_CONDUCT.md). It is not a recommendation, it is mandatory.
...
1. Take a look at the [development guideline](https://github.com/sstallion/spark-home/blob/main/docs/development.md).
2. Create your own fork of the code
3. Do the changes in your fork
4. Make sure to fill the [pull request description](https://github.com/sstallion/spark-home/blob/main/.github/PULL_REQUEST_TEMPLATE.md) properly.
